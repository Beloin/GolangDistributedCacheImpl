...
const file_greet_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\tR\x06result2L\n" +
	"\fGreetService\x12<\n" +
	"\x05Greet\x12\x18.network.v1.GreetRequest\x1a\x19.network.v1.GreetResponseB5Z3beloin.com/distributed-cache/internal/network/protob\x06proto3"
...
var file_greet_proto_goTypes = []any{
	(*GreetRequest)(nil),  // 0: network.v1.GreetRequest
	(*GreetResponse)(nil), // 1: network.v1.GreetResponse
}
var file_greet_proto_depIdxs = []int32{
	0, // 0: network.v1.GreetService.Greet:input_type -> network.v1.GreetRequest
	1, // 1: network.v1.GreetService.Greet:output_type -> network.v1.GreetResponse
